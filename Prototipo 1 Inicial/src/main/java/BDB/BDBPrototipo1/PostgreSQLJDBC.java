...
public class PostgreSQLJDBC {
   public static void main(String args[]) {
      ...
      try {
         ...
         c = DriverManager
            .getConnection("jdbc:postgresql://localhost:5432/chebi",
            "postgres", "mainadmin");
   ...
   public static void QuerySonsOfFather(Connection c) throws SQLException {
       ...
       System.out.println("Query 1 takes "+ (fin-init)+"ms to complete select");
       System.out.println();
       stmt.close();
   }
   ...
   public static void QueryCompoundName(Connection c) throws SQLException{
       ...
       System.out.println("Query 2 takes "+ (fin-init)+"ms to complete select");
       System.out.println();
       stmt.close();
   ...
   public static void QueryChemicalFormula(Connection c) throws SQLException{
       ...
       System.out.println("Query 3 takes "+ (fin-init)+"ms to complete select");
       System.out.println();
       stmt.close();
   ...
   public static void QueryStructureFromCompound(Connection c) throws SQLException{
       ...
       System.out.println("Query 4 takes "+ (fin-init)+"ms to complete select");
       System.out.println();
       stmt.close();
   ...
   public static void QueryParentSonNotStructureS(Connection c) throws SQLException{
       ...
       System.out.println("Query 5 takes "+ (fin-init)+"ms to complete select");
       System.out.println();
       stmt.close();
